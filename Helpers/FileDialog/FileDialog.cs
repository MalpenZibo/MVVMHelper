...
{
    public abstract class FileDialog : Control
    {
        /// <summary>
        /// Overridden in derviced classes to provide access to the appropriate FileDialog subclass
        /// </summary>
        protected abstract Microsoft.Win32.FileDialog Dialog
        {
            get;
        }
        ...
        public static readonly DependencyProperty AddExtensionProperty =
            DependencyProperty.Register( "AddExtension", 
                typeof(bool), 
                typeof(FileDialog), 
        ...
        public static readonly DependencyProperty CheckFileExistsProperty = 
            DependencyProperty.Register( "CheckFileExists", 
                typeof(bool), 
                typeof(FileDialog), 
        ...
        public static readonly DependencyProperty CheckPathExistsProperty =
            DependencyProperty.Register( "CheckPathExists", 
                typeof(bool), 
                typeof(FileDialog), 
                new UIPropertyMetadata( true, DialogPropertyChangedCallback ) 
            );
        ...
        public static readonly DependencyProperty CustomPlacesProperty =
            DependencyProperty.Register( "CustomPlaces", 
        ...
        public static readonly DependencyProperty DefaultExtProperty =
            DependencyProperty.Register( "DefaultExt", 
                typeof(string), 
                typeof(FileDialog), 
                new UIPropertyMetadata( string.Empty, DialogPropertyChangedCallback ) 
            );
        ...
        public static readonly DependencyProperty DereferenceLinksProperty =
            DependencyProperty.Register( "DereferenceLinks", 
                typeof(bool), 
                typeof(FileDialog), 
                new UIPropertyMetadata( false, DialogPropertyChangedCallback )
            );
        ...
        public static readonly DependencyProperty FilterIndexProperty =
            DependencyProperty.Register( "FilterIndex", 
                typeof(int), 
                typeof(FileDialog), 
        ...
        public static readonly DependencyProperty ValidateNamesProperty =
            DependencyProperty.Register( "ValidateNames", 
                typeof(bool), 
                typeof(FileDialog), 
                new UIPropertyMetadata( false, DialogPropertyChangedCallback )
            );
        ...
        {
            FileDialog dfd = obj as FileDialog;
        ...
        public static readonly DependencyProperty FileOkCommandProperty =
            DependencyProperty.Register( "FileOkCommand", 
                typeof(ICommand), 
                typeof(FileDialog)
            );
        ...
        public ICommand ShowDialogCommand
        {
            get
            {
                ...
                {
                    showDialogCommand = new RelayCommand( () => Dialog.ShowDialog() );
                }
